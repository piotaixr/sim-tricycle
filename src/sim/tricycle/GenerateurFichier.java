...
//            {"V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "X",       "X", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V", "V"},};
        ...
        String[][] mat = new String[][]{
            {"V", "V", "X", "V", "V", "V", "X", "V", "V", "V", "V", "V", "V", "X", "V", "V", "V", "X", "V", "V"},
            {"V", "V", "X", "V", "X", "V", "X", "V", "V", "V", "V", "X", "V", "V", "V", "X", "V", "X", "V", "V"},
            {"V", "X", "X", "V", "X", "V", "X", "V", "V", "V", "V", "X", "X", "X", "X", "X", "V", "X", "V", "X"},
            {"V", "V", "V", "V", "X", "V", "X", "V", "V", "V", "V", "V", "V", "V", "V", "X", "V", "X", "V", "X"},
            {"X", "X", "X", "X", "X", "V", "X", "X", "X", "X", "X", "X", "X", "X", "V", "X", "V", "X", "V", "V"},
            {"V", "V", "V", "V", "V", "V", "V", "V", "X", "V", "X", "V", "V", "X", "V", "X", "V", "X", "V", "V"},
            ...
            {"X", "X", "X", "X", "X", "V", "X", "X", "X", "V", "V", "V", "V", "X", "V", "X", "V", "X", "V", "V"},
            {"V", "V", "V", "X", "V", "V", "V", "V", "V", "V", "V", "V", "X", "V", "V", "V", "V", "X", "X", "X"},
            {"V", "X", "X", "V", "V", "V", "V", "V", "X", "V", "X", "X", "X", "V", "V", "V", "X", "V", "V", "V"},
            {"V", "X", "V", "V", "X", "X", "X", "X", "V", "V", "X", "X", "X", "V", "V", "V", "X", "V", "X", "V"},
            {"V", "X", "V", "V", "V", "V", "V", "X", "X", "X", "X", "V", "V", "V", "V", "V", "X", "V", "X", "V"},
            {"V", "V", "V", "X", "V", "V", "V", "V", "V", "v", "X", "V", "X", "X", "X", "X", "X", "V", "X", "V"},
            {"V", "V", "V", "X", "V", "V", "V", "V", "V", "v", "V", "V", "V", "V", "V", "V", "V", "V", "X", "V"},};

        HashMap<Integer, LinkedList<sim.tricycle.robot.Point>> dispositions = new HashMap();
        sim.tricycle.robot.Point zero = new Point(1, 1);
        sim.tricycle.robot.Point zero2 = new sim.tricycle.robot.Point(18, 18);
        LinkedList listzero = new LinkedList<sim.tricycle.robot.Point>();
        listzero.add(zero);
        listzero.add(zero2);
        dispositions.put(2, listzero);

        sim.tricycle.robot.Point un = new sim.tricycle.robot.Point(1, 1);
        sim.tricycle.robot.Point un2 = new sim.tricycle.robot.Point(18, 1);
        sim.tricycle.robot.Point un3 = new sim.tricycle.robot.Point(9, 18);
        ...
        sim.tricycle.robot.Point deux = new sim.tricycle.robot.Point(1, 1);
        sim.tricycle.robot.Point deux2 = new sim.tricycle.robot.Point(18, 1);
        sim.tricycle.robot.Point deux3 = new sim.tricycle.robot.Point(1, 18);
        sim.tricycle.robot.Point deux4 = new sim.tricycle.robot.Point(18, 18);
